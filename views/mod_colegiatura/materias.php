<main class="content-wrapper">
    ...
    <article class="container-fluid">
        <section class="row my-2 justify-content-center" id="principal">
            <div class="col-lg-11">
                <h1 class="text-center my-3">Materias</h1>
                <div class="table-responsive">
                    <table class="table table-hover">
                        <thead class="thead-dark">
                            <tr class="text-center">
                                <th colspan="4">
                                    <a href="" id="Add" class="btn btn-success" data-toggle="modal" data-target="#modalMateria">Nuevo</a>
                                </th>
                            </tr>
                            <tr class="text-center">
                                <th>Materia</th>
    ...
    <div class="modal fade" id="modalMateria" tabindex="-1" aria-labelledby="LabelModalMateria" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
